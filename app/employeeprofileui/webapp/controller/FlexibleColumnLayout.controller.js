sap.ui.define([
	...
	return Controller.extend("employeeprofileui.controller.FlexibleColumnLayout", {
		onInit: function () {
		...
		onBeforeRouteMatched: function(oEvent) {
			...
			var oModel = this.getOwnerComponent().getModel("uiState");
		...
		onRouteMatched: function (oEvent) {
			...
			this.currentManager = oArguments.manager;
		},
		...
		onColumnsDistributionChange: function (oEvent) {
			var sMedia = oEvent.getParameter("media"),
				...
				oModel =  this.getView().getModel("uiState"),
		...
		onStateChanged: function (oEvent) {
			...
			if (bIsNavigationArrow) {
				this.oRouter.navTo(this.currentRouteName, {layout: sLayout, employee: this.currentEmployee, manager: this.currentManager}, true);
			}
		},
